...
public class UserTest {
    ...
    /* Output
    Не зависимо то того, что поля обьктов u1 и u2 одинаковые, создается два разных объекта,
    ...
    По усолчанию hashCode() возвращает адрес обьекта. Таким образом хеш-код экземпляра
    u1 не совпадает с хеш-кодом u2.
    Так же не переопределен метод equals() класса Object. Данный метод по уполчанию сводится
